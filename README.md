...
- **17 个大洲/大地域**：奥苏安、纳迦罗斯、露斯契亚、南地、帝国、诺斯卡、基斯里夫、震旦……
...
| 路径 | 说明 |
| --- | --- |
| `index.html` | 地图册本体（1.8MB，纯静态，无外部依赖） |
| `assets/map_combi.jpg` | 超凡帝国底图（4000×3111） |
| `assets/map_chaos.jpg` | 混沌之域底图（4000×3010） |
| `assets/faction_flags.png` | 286 个派系旗帜的雪碧图（16 列 × 48px 单元格） |
| `data/atlas_api.json` | 结构化数据接口：全部城镇与大洲数据（含三种坐标、行省、派系、旗帜格位） |
